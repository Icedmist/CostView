...
export function OnboardingModal({ isOpen, onClose }: OnboardingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-navy-950/75 backdrop-blur-xs flex items-center justify-center p-3 md:p-6 overflow-y-auto">
      <div className="bg-[#fbfbfb] border-[3px] border-[#e5e5e5] shadow-card max-w-4xl w-full max-h-[90vh] flex flex-col my-auto overflow-hidden">
        {/* Modal Top Banner */}
        <div className="bg-navy-800 text-white px-5 py-4 flex items-center justify-between border-b border-[#e5e5e5] shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-blue-50 text-[#0067c0] border-blue-200 border-2 border-white flex items-center justify-center text-[#1b1b1b] shadow-xs shrink-0">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs bg-blue-50 text-[#0067c0] border-blue-200 text-[#1b1b1b] px-2 py-0.5 border border-[#e5e5e5] font-mono font-bold hidden sm:inline-block">
                  v2.0 Manual
                </span>
              </div>
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 bg-white border border-[#e5e5e5] text-[#1b1b1b] hover:bg-blue-50 text-[#0067c0] border-blue-200 flex items-center justify-center shadow-xs transition-colors"
            title="Close modal"
          >
            <X className="w-5 h-5" />
          </button>
        ...
        {/* Tab Navigation */}
        <div className="bg-[#fbfbfb] border-b border-[#e5e5e5] px-4 py-2 flex flex-wrap gap-2 shrink-0">
          <button
            onClick={() => setActiveTab("overview")}
            className={`px-3 py-1.5 text-xs font-black uppercase tracking-wide border border-[#e5e5e5] transition-all ${
              activeTab === "overview"
                ? "bg-navy-800 text-white shadow-xs"
                : "bg-white text-[#1b1b1b] hover:bg-[#f5f5f5]"
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 text-xs font-black uppercase tracking-wide border border-[#e5e5e5] transition-all flex items-center gap-1.5 ${
              activeTab === "dataflow"
                ? "bg-navy-800 text-white shadow-xs"
                : "bg-white text-[#1b1b1b] hover:bg-[#f5f5f5]"
            }`}
        ...
        {/* Tab Content Body */}
        <div className="p-5 overflow-y-auto space-y-5 text-[#1b1b1b] flex-1">
          {/* TAB 1: OVERVIEW */}
          {activeTab === "overview" && (
            <div className="space-y-4">
              <div className="bg-white border border-[#e5e5e5] p-4 shadow-xs">
                <h3 className="text-sm font-black text-[#1b1b1b] uppercase tracking-wide flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-emerald-600" />
                  Why CostView 360 Exists: Eliminating Commercial Construction Cost Leakage
                </h3>
                <p className="text-xs text-[#1b1b1b]/80 mt-1 leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="w-6 h-6 bg-navy-800 text-[#0067c0] font-mono font-bold text-xs flex items-center justify-center border border-[#e5e5e5]">
                      ₦
                    </span>
                    <h4 className="text-xs font-black uppercase text-[#1b1b1b]">1. NGN-Native Valuation</h4>
                  </div>
                ...
                <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="text-xs font-black uppercase text-[#1b1b1b]">2. Automated 3-Way Match</h4>
                  </div>
                  <p className="text-xs text-[#1b1b1b]/80">
                ...
                <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="text-xs font-black uppercase text-[#1b1b1b]">3. 10% Statutory Retention</h4>
                  </div>
                  <p className="text-xs text-[#1b1b1b]/80">
                ...
                <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="text-xs font-black uppercase text-[#1b1b1b]">4. Dual-Signoff Governance</h4>
                  </div>
                  <p className="text-xs text-[#1b1b1b]/80">
              ...
              <div className="bg-white border border-[#e5e5e5] p-4 shadow-xs">
                <h4 className="text-xs font-black uppercase text-[#1b1b1b] mb-2">User Roles & Operational Responsibilities</h4>
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs border border-[#e5e5e5]">
                    <thead className="bg-navy-800 text-white font-mono">
                      <tr>
                        <th className="p-2 border border-[#e5e5e5]">Role</th>
                        <th className="p-2 border border-[#e5e5e5]">Key Daily & Monthly Tasks</th>
                        <th className="p-2 border border-[#e5e5e5]">Primary Module</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-navy-800 text-[#1b1b1b]">
                      <tr>
          ...
          {activeTab === "workflows" && (
            <div className="space-y-4">
              <div className="bg-blue-50 border border-[#e5e5e5] p-4 shadow-xs">
                <h3 className="text-sm font-black text-[#1b1b1b] uppercase tracking-wide">
                  Standard Operating Procedures: Step-by-Step User Instructions
                </h3>
                <p className="text-xs text-[#1b1b1b]/80 mt-1">
              ...
              {/* Step 1 */}
              <div className="bg-white border border-[#e5e5e5] p-4 shadow-xs space-y-2">
                <div className="flex items-center gap-2">
                  <span className="bg-navy-800 text-[#0067c0] font-mono font-bold px-2 py-0.5 text-xs">PHASE 1</span>
                  <h4 className="text-xs font-black uppercase text-[#1b1b1b]">Project Setup & BOQ Baseline Budget Locking</h4>
                </div>
                <ol className="text-xs text-[#1b1b1b]/80 space-y-1.5 list-decimal list-inside">
              ...
              <div className="bg-white border border-[#e5e5e5] p-4 shadow-xs space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-xs font-black uppercase text-[#1b1b1b]">Daily Site Operations, Attendance & Inspections</h4>
                </div>
                <ol className="text-xs text-[#1b1b1b]/80 space-y-1.5 list-decimal list-inside">
              ...
              <div className="bg-white border border-[#e5e5e5] p-4 shadow-xs space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-xs font-black uppercase text-[#1b1b1b]">Procurement & 3-Way Invoice Matching (Zero Overpayment)</h4>
                </div>
                <ol className="text-xs text-[#1b1b1b]/80 space-y-1.5 list-decimal list-inside">
              ...
              <div className="bg-white border border-[#e5e5e5] p-4 shadow-xs space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-xs font-black uppercase text-[#1b1b1b]">Subcontractor Valuations & 10% Statutory Retention</h4>
                </div>
                <ol className="text-xs text-[#1b1b1b]/80 space-y-1.5 list-decimal list-inside">
              ...
              <div className="bg-white border border-[#e5e5e5] p-4 shadow-xs space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-xs font-black uppercase text-[#1b1b1b]">Site Instructions & 4-Stage Variation Orders</h4>
                </div>
                <ol className="text-xs text-[#1b1b1b]/80 space-y-1.5 list-decimal list-inside">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-3 py-1.5 text-xs font-bold uppercase border border-[#e5e5e5] transition-all ${
                    activeFlow === "lifecycle"
                      ? "bg-navy-800 text-[#0067c0] shadow-xs"
                      : "bg-white text-[#1b1b1b] hover:bg-[#fbfbfb]"
                  }`}
                >
              ...
              {activeFlow === "lifecycle" && (
                <div className="space-y-3">
                  <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-4 shadow-xs space-y-3">
                    <div className="flex items-center justify-between border-b border-[#e5e5e5] pb-2">
                      <span className="font-black text-xs uppercase text-[#1b1b1b] flex items-center gap-2">
                        <Building2 className="w-4 h-4 text-blue-700" />
                        Three-Tier Enterprise Data Flow Architecture
                      </span>
                      <button
                        onClick={() => copyToClipboard(mermaidLifecycle, "lifecycle")}
                        className="px-2 py-1 bg-white hover:bg-[#f5f5f5] text-[#1b1b1b] border border-[#e5e5e5] text-[11px] font-mono font-bold flex items-center gap-1 shadow-xs"
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                          <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-2">
                            <span className="font-bold block">1. Daily Site Diary &amp; Muster</span>
                            <span className="text-[11px] text-[#1b1b1b]/70">Weather, delays, artisan counts, overtime hours</span>
                          </div>
                          <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-2">
                            <span className="font-bold block">2. Deliveries &amp; GRN</span>
                            <span className="text-[11px] text-[#1b1b1b]/70">Storekeeper physical count, warehouse stock gauges</span>
                          </div>
                          <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-2">
                            <span className="font-bold block">3. Element QA/QC</span>
                            <span className="text-[11px] text-[#1b1b1b]/70">Structural signoffs; failed checks auto-create snags</span>
                          </div>
                        </div>
                      </div>

                      <div className="flex justify-center">
                        <div className="bg-navy-800 text-[#0067c0] font-mono font-bold text-[10px] px-3 py-0.5 border border-[#e5e5e5] flex items-center gap-1">
                      ...
                      <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                          <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-2">
                            ...
                            <span className="text-[11px] text-[#1b1b1b]/70">Master quantities, unit rates, contingency reserve</span>
                          </div>
                          <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-2">
                            <span className="font-bold block">5. 3-Way Match Gate</span>
                            <span className="text-[11px] text-[#1b1b1b]/70">PO vs GRN vs Invoice; zero price or quantity delta</span>
                          </div>
                          <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-2">
                            <span className="font-bold block">6. Subcontractor Ledger</span>
                            <span className="text-[11px] text-[#1b1b1b]/70">Milestone claims, auto 10% retention withholding</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                          <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-2">
                            ...
                            <span className="text-[11px] text-[#1b1b1b]/70">Real-time CPI, SPI, budget health status badge</span>
                          </div>
                          <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-2">
                            <span className="font-bold block">8. 4-Stage Variations</span>
                            <span className="text-[11px] text-[#1b1b1b]/70">SI logged &rarr; QS costed &rarr; PM approved &rarr; baseline uplift</span>
                          </div>
                          <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-2">
                            <span className="font-bold block">9. Executive PDF Reports</span>
                            <span className="text-[11px] text-[#1b1b1b]/70">Boardroom exports, bank valuation, immutable audit</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-3">
                  <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-4 shadow-xs space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                      <div className="bg-white border border-[#e5e5e5] p-2.5">
                        <span className="text-xs font-bold text-[#1b1b1b] block">Doc 1: Purchase Order</span>
                        <p className="text-[11px] text-[#1b1b1b]/70 mt-0.5">Agreed commercial contract rate &amp; ordered quantity.</p>
                      </div>
                      <div className="bg-white border border-[#e5e5e5] p-2.5">
                        <span className="text-xs font-bold text-[#1b1b1b] block">Doc 2: Site GRN</span>
                        <p className="text-[11px] text-[#1b1b1b]/70 mt-0.5">Physical count verified by site storekeeper upon delivery.</p>
                      </div>
                      <div className="bg-white border border-[#e5e5e5] p-2.5">
                        <span className="text-xs font-bold text-[#1b1b1b] block">Doc 3: Vendor Invoice</span>
                        <p className="text-[11px] text-[#1b1b1b]/70 mt-0.5">Billed unit price and claimed quantity from supplier.</p>
                      </div>
                    </div>

                    <div className="bg-blue-100 border border-[#e5e5e5] p-3 text-center">
                      <span className="font-mono font-black text-xs uppercase text-[#1b1b1b]">
                        ⚡ Reconciled Automatically by CostView 360 Matching Engine
                      </span>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="bg-white border-2 border-emerald-600 p-3 shadow-xs">
                        <span className="font-bold text-xs text-emerald-700 flex items-center gap-1.5 mb-1">
                          <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                          Perfect Match (0% Delta)
                        </span>
                        <p className="text-[11px] text-[#1b1b1b]/80">
                          Unit price and quantity agree 100%. Finance signs off, invoice is approved, and disbursement is cleared.
                        </p>
                      </div>
                      <div className="bg-white border-2 border-red-600 p-3 shadow-xs">
                  ...
                  <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-4 shadow-xs space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                      <div className="bg-white border border-[#e5e5e5] p-2.5">
                        ...
                        <p className="text-[11px] text-[#1b1b1b]/70 mt-0.5">Contractor submits monthly payment valuation.</p>
                      </div>
                      <div className="bg-white border border-[#e5e5e5] p-2.5">
                        ...
                        <p className="text-[11px] text-[#1b1b1b]/70 mt-0.5">QS validates physical work on site.</p>
                      </div>
                      <div className="bg-white border border-[#e5e5e5] p-2.5">
                        ...
                        <p className="text-[11px] text-[#1b1b1b]/70 mt-0.5">System isolates 10% in escrow; 90% net paid.</p>
                      </div>
                      <div className="bg-white border border-[#e5e5e5] p-2.5">
                        ...
                        <p className="text-[11px] text-[#1b1b1b]/70 mt-0.5">5% released on handover; 5% after 6-month defect period.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="bg-[#fbfbfb] border border-[#e5e5e5] p-4 shadow-xs space-y-3">
                    ...
                    <div className="space-y-2 text-xs">
                      <div className="flex items-start gap-3 bg-white border border-[#e5e5e5] p-2.5">
                        ...
                        <div>
                          <span className="font-bold block text-[#1b1b1b]">Site Instruction (SI) Issued</span>
                          <span className="text-[11px] text-[#1b1b1b]/70">Architect or Resident Engineer registers formal instruction in module 7.1 with sketches.</span>
                        </div>
                      </div>
                      <div className="flex items-start gap-3 bg-white border border-[#e5e5e5] p-2.5">
                        ...
                        <div>
                          <span className="font-bold block text-[#1b1b1b]">QS Cost &amp; Time Valuation</span>
                          <span className="text-[11px] text-[#1b1b1b]/70">Quantity Surveyor attaches contract unit rates, material quantities, and schedule delay estimate.</span>
                        </div>
                      </div>
                      <div className="flex items-start gap-3 bg-white border border-[#e5e5e5] p-2.5">
                        ...
                        <div>
                          <span className="font-bold block text-[#1b1b1b]">Project Manager Review</span>
                          <span className="text-[11px] text-[#1b1b1b]/70">PM evaluates impact against contingency reserve and project handover schedule.</span>
                        </div>
                      </div>
                      <div className="flex items-start gap-3 bg-white border border-[#e5e5e5] p-2.5">
                        ...
                        <div>
                          <span className="font-bold block text-[#1b1b1b]">Client Approval &amp; Baseline Uplift</span>
                          <span className="text-[11px] text-[#1b1b1b]/70">Client signs off; master budget baseline automatically uplifts and extra work is committed.</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          {activeTab === "pdf" && (
            <div className="space-y-4">
              <div className="bg-blue-50 border border-[#e5e5e5] p-5 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-xs bg-navy-800 text-[#0067c0] font-mono font-black px-2 py-0.5 border border-[#e5e5e5]">
                      OFFICIAL PUBLICATION
                    </span>
                    <span className="text-xs font-bold text-[#1b1b1b]">5-Page Branded Neo-Brutalist PDF</span>
                  </div>
                  <h3 className="text-base font-black text-[#1b1b1b] uppercase tracking-tight">
                    CostView 360 · Comprehensive Enterprise User Manual
                  </h3>
                  <p className="text-xs text-[#1b1b1b]/80 mt-1 max-w-xl">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 shrink-0">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="px-4 py-2.5 bg-white hover:bg-[#fbfbfb] text-[#1b1b1b] border border-[#e5e5e5] shadow-xs font-black text-xs uppercase flex items-center justify-center gap-1.5 transition-transform active:translate-x-0.5 active:translate-y-0.5"
                  >
                  ...
                  <a
                    ...
                    className="px-4 py-2.5 bg-navy-800 hover:bg-navy-900 text-[#0067c0] border border-[#e5e5e5] shadow-xs font-black text-xs uppercase flex items-center justify-center gap-1.5 transition-transform active:translate-x-0.5 active:translate-y-0.5"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-2.5">
                <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                  <div className="text-[10px] font-mono font-bold bg-navy-800 text-[#0067c0] px-1.5 py-0.5 w-fit mb-1">
                    PAGE 1
                  </div>
                  <h5 className="text-xs font-black uppercase text-[#1b1b1b]">Cover &amp; Data Flow</h5>
                  <p className="text-[11px] text-[#1b1b1b]/70 mt-1">
                ...
                <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                  ...
                  <h5 className="text-xs font-black uppercase text-[#1b1b1b]">The 10 Subsystems</h5>
                  <p className="text-[11px] text-[#1b1b1b]/70 mt-1">
                ...
                <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                  ...
                  <h5 className="text-xs font-black uppercase text-[#1b1b1b]">Setup &amp; Field Routines</h5>
                  <p className="text-[11px] text-[#1b1b1b]/70 mt-1">
                ...
                <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                  ...
                  <h5 className="text-xs font-black uppercase text-[#1b1b1b]">3-Way Match &amp; Retention</h5>
                  <p className="text-[11px] text-[#1b1b1b]/70 mt-1">
                ...
                <div className="bg-white border border-[#e5e5e5] p-3 shadow-xs">
                  ...
                  <h5 className="text-xs font-black uppercase text-[#1b1b1b]">Variations &amp; Troubleshoot</h5>
                  <p className="text-[11px] text-[#1b1b1b]/70 mt-1">
        ...
        <div className="bg-[#fbfbfb] border-t border-[#e5e5e5] px-5 py-3 flex items-center justify-between shrink-0">
          <span className="text-xs text-[#1b1b1b] font-bold hidden sm:inline-block">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-3 py-1.5 bg-white text-[#1b1b1b] border border-[#e5e5e5] shadow-xs font-bold text-xs uppercase hover:bg-[#f5f5f5] transition-colors flex items-center gap-1"
            >
            ...
            <button
              onClick={onClose}
              className="px-4 py-1.5 bg-navy-800 text-white border border-[#e5e5e5] shadow-xs font-bold text-xs uppercase hover:bg-navy-900 transition-colors"
            >
              Got It
            </button>
          </div>
