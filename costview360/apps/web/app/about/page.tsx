...
export const metadata = { title: "About — CostView", description: "Vision, team, stack, Lagos context." };
    ...
    <div className="min-h-screen bg-cream-100 text-navy-800 font-sans">
      ...
      <header className="border-b-[3px] border-navy-800 bg-navy-800 text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-10 md:py-14">
          <div className="inline-block bg-mustard-400 text-navy-800 border-[3px] border-navy-800 px-4 py-2 font-black uppercase text-sm">Our Story</div>
          <h1 className="mt-4 text-4xl md:text-5xl font-black tracking-tighter leading-none">Built in Lagos.<br /><span className="text-mustard-400">For Builders Everywhere.</span></h1>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="bg-white border-[3px] border-navy-800 p-6 md:p-8 shadow-brutal">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="bg-cream-100 border-2 border-navy-800 p-4"><Building2 className="w-6 h-6 mb-2" /><div className="font-black uppercase text-xs">Eko Atlantic</div><div className="text-xs font-bold text-navy-800/60">Horizon Towers — flagship pilot</div></div>
              <div className="bg-mustard-400 border-2 border-navy-800 p-4"><MapPin className="w-6 h-6 mb-2" /><div className="font-black uppercase text-xs">Lekki</div><div className="text-xs font-bold">Commercial Complex — planning</div></div>
            </div>
          </div>
          <div className="space-y-4">
            ...
            <div className="bg-white border-[3px] border-navy-800 p-6 shadow-brutal">
              ...
              <ul className="mt-3 space-y-2 text-sm font-bold">
                ...
                <li className="flex gap-2"><span className="w-2 h-2 bg-mustard-400 mt-2 shrink-0 border border-navy-800" />Supabase Postgres (25 tables, RLS) — eu-central-1</li>
      ...
      <section className="bg-white border-y-[3px] border-navy-800">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-10">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-cream-100 border-[3px] border-navy-800 p-6 shadow-brutal"><Zap className="w-8 h-8 mb-3" /><h4 className="font-black uppercase">Fast</h4><p className="text-sm font-bold text-navy-800/60 mt-2">Less typing — linked documents carry forward.</p></div>
            <div className="bg-mustard-400 border-[3px] border-navy-800 p-6 shadow-brutal"><Users className="w-8 h-8 mb-3" /><h4 className="font-black uppercase">Efficient</h4><p className="text-sm font-bold mt-2">Right module for right role, auto routing.</p></div>
